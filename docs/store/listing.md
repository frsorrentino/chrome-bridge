...
Bridge your browser to Claude Code: 64 token-efficient web-dev automation tools over a local WebSocket. ChromeOS included.
...
64 specialized web-development tools:
