...
Bridge your browser to Claude Code: 58 token-efficient web-dev automation tools over a local WebSocket. ChromeOS included.
...
58 specialized web-development tools:
