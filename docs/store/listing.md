...
Bridge your browser to Claude Code: 61 token-efficient web-dev automation tools over a local WebSocket. ChromeOS included.
...
61 specialized web-development tools:
