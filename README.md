...
| **Tools** | **60** (36 core) | ~20 | ~50 | 23 core (71 total) |
...
60 in total, in seven groups. Only `core` (36 tools) loads by default; the rest
are opt-in via `--caps`.
...
|---|---|---|
| Core & Navigation | 11 | tabs, windows, `navigate`, `screenshot`, `tile_windows` |
